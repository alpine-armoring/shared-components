...
const PauseIcon = () => {
    return (React.createElement("svg", { height: "30", width: "30", viewBox: "0 0 271.953 271.953", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("title", null, "Pause video"),
        React.createElement("g", { id: "SVGRepo_bgCarrier", strokeWidth: "0" }),
        React.createElement("g", { id: "SVGRepo_tracerCarrier", strokeLinecap: "round", strokeLinejoin: "round" }),
        React.createElement("g", { id: "SVGRepo_iconCarrier" },
            ' ',
            React.createElement("g", null,
                ...
                React.createElement("g", null,
                    ...
                    ' ',
                    React.createElement("path", { style: { fill: '#ffff' }, d: "M110.707,200.114c7.511,0,13.598-6.086,13.598-13.598V83.174c0-7.511-6.086-13.598-13.598-13.598 c-7.511,0-13.598,6.086-13.598,13.598v103.342C97.109,194.028,103.195,200.114,110.707,200.114z" }),
                    ' ',
                    React.createElement("path", { style: { fill: '#ffff' }, d: "M165.097,200.114c7.511,0,13.598-6.086,13.598-13.598V83.174c0-7.511-6.086-13.598-13.598-13.598 S151.5,75.663,151.5,83.174v103.342C151.5,194.028,157.586,200.114,165.097,200.114z" }),
                    ' '),
                ' '),
            ' ')));
};
...
const BannerFull = ({ props }) => {
    ...
    return (React.createElement("div", { className: `${styles.hp_banner}` },
        React.createElement("div", { className: `${styles.hp_banner_inner}` },
            ((_c = props.video) === null || _c === void 0 ? void 0 : _c.video_webm.data) || ((_d = props.video) === null || _d === void 0 ? void 0 : _d.video_mp4.data) ? (React.createElement("video", { ref: videoRef, muted: true, autoPlay: true, playsInline: true, preload: "auto", className: `${styles.hp_banner_video}` },
                props.video.video_webm.data ? (React.createElement("source", { src: `${props.video.video_webm.data.attributes.url}`, type: `${props.video.video_webm.data.attributes.mime}` })) : null,
                props.video.video_mp4.data && !props.video.video_webm.data ? (React.createElement("source", { src: `${props.video.video_mp4.data.attributes.url}`, type: `${props.video.video_mp4.data.attributes.mime}` })) : null)) : null,
            React.createElement("div", { className: `${styles.hp_banner_pause}`, onClick: togglePlayPause }, isPlaying ? React.createElement(PauseIcon, null) : React.createElement(PlayIcon, null)),
            React.createElement("div", { className: `${styles.hp_banner_content}` },
                props.title ? (React.createElement("h1", { dangerouslySetInnerHTML: {
                        __html: props.title,
                    }, className: `${styles.hp_banner_title}` })) : null,
                props.description ? (React.createElement("h2", { className: `${styles.hp_banner_description}`, dangerouslySetInnerHTML: { __html: props.description } })) : null)),
